source("C:/R/R-4.4.3/Cerema/Diff_MNT_Filtree.R")
cat("\014")
...
NomDirMNTTIN=NomDirMNTTIN_F
racilayerTA="TA_HD"

textdeb="LHD_FXX_"
textfin="_PTS_C_LAMB93_IGN69_copc_"
nomTIN="TIN_Filino" #"TIN_Direct"
nfiltre=9
...
for (ix in (702:738))
{
  for (iy in 6236:6259)
  {
    ...
    if (file.exists(nomMNTa)==T & file.exists(nomMNTb)==T & file.exists(nomMasque)==T & file.exists(nomPtsVirtLaz)==F)
    {
