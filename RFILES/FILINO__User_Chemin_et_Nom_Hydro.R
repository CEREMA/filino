...
paramTARaster=as.data.frame(rbind(
  ...
  cbind(0,file.path(dsnlayer,NomDirMNTGDAL)     ,"TA_SOLetEAU_min.shp"       ,"SOLetEAU_min.gpkg$",9,12,14,17),
  cbind(0,file.path(dsnlayer,NomDirMNTGDAL)     ,"TA_SOLetEAU_max.shp"       ,"SOLetEAU_max.gpkg$",9,12,14,17),
  cbind(0,file.path(dsnlayer,NomDirMNTGDAL)     ,"TA_SOLetEAU_stdev.shp"       ,"SOLetEAU_stdev.gpkg$",9,12,14,17),
  ...
  cbind(0,file.path(dsnlayer,NomDirMNTGDAL)     ,"TA_TOUT_min.shp"           ,"TOUT_min.gpkg$",9,12,14,17),
  cbind(0,file.path(dsnlayer,NomDirMNTGDAL)     ,"TA_VEGE_min.shp"           ,"VEGE_min.gpkg$",9,12,14,17),
  cbind(0,file.path(dsnlayer,NomDirMNTGDAL)     ,"TA_BATI_max.shp"           ,"BATI_max.gpkg$",9,12,14,17),
  ...
  cbind(0,"C:\\Cartino2D\\France\\_Strickler","TA_Strickler_MTP20240705.gpkg"            ,".gpkg$",11,14,16,19),
  cbind(0,"C:\\Cartino2D\\France\\_Strickler\\CNIR","TA_CN_CNIR.gpkg"            ,".gpkg$",6,9,11,14),
  cbind(0,"C:\\Cartino2D\\France\\_MNT\\MAMP_2024","TA_MNTC2D_MAMP2024.gpkg"   ,".gpkg$",17,20,22,25),
  cbind(0,"G:\\MNT_Frontaliers\\Allemagne\\Rhenanie_Palatinat","TA_Allemagne_RLP.gpkg",".tif$",10,12,14,17),
  cbind(0,"G:\\MNT_Frontaliers\\Allemagne\\Baden_Wurttemberg\\Dalles","TA_Allemagne_BW_XYZ.gpkg",".xyz$",9,11,13,16),
  cbind(0,"G:\\MNT_Frontaliers\\Allemagne\\Baden_Wurttemberg\\DallesGPKG","TA_Allemagne_BW_GPKG.gpkg",".gpkg$",9,11,13,16),
  cbind(0,"G:\\MNT_Frontaliers\\Suisse","TA_Suisse.gpkg",".tif$",4,1,4,0),
  cbind(0,"G:\\MNT_Frontaliers\\LUXEMBOURG\\Dalles2169","TA_Luxembourg.gpkg",".gpkg$",9,12,14,17),
  cbind(0,"G:\\MNT_Frontaliers\\BELGIQUE\\FLANDRES\\Dalles31370","TA_Belg_Fland.gpkg",".gpkg$",16,19,21,24),
  cbind(0,"G:\\MNT_Frontaliers\\BELGIQUE\\WALLONIE\\Dalles3812","TA_Belg_Wallo.gpkg",".gpkg$",15,18,20,23),
  cbind(0,"G:\\MNT_Frontaliers\\_FusionMNT","TA_Frontaliers.gpkg","_NGF.gpkg$",4,1,4,0),
  cbind(0,"G:\\MNT_Frontaliers\\_Frontieres\\Dalles","TA_Frontieres.gpkg",".gpkg$",4,1,4,0)
))
