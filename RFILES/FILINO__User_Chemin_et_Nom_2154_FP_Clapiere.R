...
dsnlayer="C:/AFFAIRES/FILINO_Travail_Clapiere"
...
dsnDepartement="C:\\BDTopo"

paramTALidar=as.data.frame(rbind(
  cbind(1,"C:\\StockageLIDAR"                    ,"TA_HD.shp"           ,0.5,41, 9,12,14,17,1),
  # cbind(1,"F:/LidarHD_DC"                       ,"TA_HD_surF.shp"      ,0.5,41, 9,12,14,17,1),
  ...
  cbind(1,"G:/2_IGNF_LIDAR_HD_TAmnt_dalle"      ,"TA_MNT_HD_P.shp"     ,0.5,41, 9,12,14,17,1)
))
...
nomTA_SiteIGN=file.path("TA_IGN_WFS","TA_Lidar.shp")
...
paramTARaster=as.data.frame(rbind(
  ...
  cbind(1,"E:\\RGEAlti1m\\France"               ,"TA_RGEALTI_FR.shp"            ,".asc$",4,1,4,0),
  cbind(1,"E:\\BugRGE"                          ,"BugTA_RGEALTI_FR.gpkg"            ,".gpkg$",4,1,4,0),
  ...
  # cbind(0,"C:\\Cartino2D\\France\\_CN","TA_CN_C_MTP20240705.gpkg"               ,".gpkg$",6,9,11,14),
  cbind(0,"C:\\Cartino2D\\France\\_CN\\MAMP","TA_CN_C_MAMP20240802.gpkg"               ,".gpkg$",6,9,11,14),
  # cbind(0,"C:\\Cartino2D\\France\\_Strickler","TA_Strickler_MTP20240705.gpkg"            ,".gpkg$",11,14,16,19),
  cbind(0,"C:\\Cartino2D\\France\\_Strickler\\MAMP","TA_Strickler_MAMP20240802.gpkg"            ,".gpkg$",11,14,16,19),
  cbind(0,"E:\\Litto3D"                      ,"TA_Litto3D.gpkg"                ,".asc$",13,16,18,21),
...
QueHydrometrie=1
NomStHydro="C:\\AFFAIRES\\INRAE\\Hydrometrie\\StationHydro_FXX_selectFILINO.gpkg"
